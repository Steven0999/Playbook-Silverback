...
const PLAYBOOK = {
    ...
    Stack: [
        { // Step 0: Starting Position (Inbounds)
            description: "Initial Setup for Stack: Big (5), Guard (2), Big (4), Guard (3) stacked from the block. Inbounder (1) under the basket.",
            positions: [
        ...
        { // Step 4: Final Options (Ball passed to 3) - 3 now has ball
            ...
            positions: [
                ...
                { id: 5, label: '5', color: '#8b5cf6', x: 7.5, y: 35, isBall: false }, 
                { id: 6, label: '🏀', color: 'none', x: 40.5, y: 35, isBall: true }
            ],
            highlight: [1, 2, 4, 5, 6],
            actions: [
